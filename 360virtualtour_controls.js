...
"buttonBox": [
        {
            ...
            "button": [
                ...
                },
                {
                    ...
                    "onscenechanged": "function(){ var d=this.viewer.get('localData'); var g=this.viewer.get('globalData'); var o=d&&d.infoTextBox||g&&g.infoTextBox; this.setVisible(!!o); if (!!o){ if (d&&d.infoTextBox) this.viewer.action('hideMessage'); this.viewer.action('showMessage',o); } }",
                    "priority": 3,
...
"events": {
        ...
        "oninit": "function(){ var g = this.viewer.gallery(); this.viewer.hasGallery = ((!!g) && g.length>1); this.viewer.checkForGyroscope(); var v = this.viewer.getView(); this.viewer.action('littlePlanetIntro',v.pan,v.tilt,v.hfov);  }",
